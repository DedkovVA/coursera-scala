...
//    assert(1 + 1 === 3) // Fix me, please!
  ...
  test("sum of a few numbers2") {
    assert(sum(List(1,2,-1,-2)) === 0)
  }
  test("sum of a few numbers3") {
    assert(sum(List(1)) === 1)
  }
  test("sum of a few numbers4") {
    assert(sum(List()) === 0)
  }
  test("sum of a few numbers5") {
    assert(sum(List(0)) === 0)
  }
  ...
  test("max of a few numbers2") {
    ...
    assert(thrown.getClass.getSimpleName == "NoSuchElementException")
  }
  test("max of a few numbers3") {
    assert(max(List(3)) === 3)
  }
  test("max of a few numbers4") {
    assert(max(List(3, 7)) === 7)
  }
  test("max of a few numbers5") {
    assert(max(List(0)) === 0)
  }
